...
export default function DetalhesChamado() {
  ...
  // Estados para o relatório de conclusão
  ...
  // Estado para controlar a exibição do collapse
  ...
  return (
    <div className="container mt-4">
      ...
      <div className="d-flex align-items-center mb-4">
        <a href="/admin/chamados" className={`text-decoration-none fs-5 me-2`}>
      ...
      {chamado.status === 'concluído' && (
        <>
          <div className="d-grid gap-2 mt-5 mb-3">
            <button
              className='btnAbrirRelatorio'
              type="button"
              onClick={() => setShowCollapse(!showCollapse)}
            >
              <span>Ver relatório de conclusão</span>
